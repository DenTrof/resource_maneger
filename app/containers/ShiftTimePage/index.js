...
export class ShiftTimePage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      data: [],
    ...
    return (
      <div id="shift">
        <div className="animated fadeIn">
          <Card>
            <CardHeader>Справочник Планирование Смен</CardHeader>
            <CardBody>
              <ModalValuesForm />
              <BootstrapTable
