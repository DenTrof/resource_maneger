...
export class ChangePositionPage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      positionId: null,
  ...
  componentDidUpdate() {
    const positionId = reactLocalStorage.get('equipId');
    ...
    return (
      <div id="position">
        <div className="animated fadeIn">
          <Card>
            <CardHeader>Карточка Должности</CardHeader>
            <CardBody>
              <PositionModal
